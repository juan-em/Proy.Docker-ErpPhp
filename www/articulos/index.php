						...
						<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
							...
							<tr>
								...
								<td><select id="cboFamilias" name="cboFamilias" class="comboMedio">
										...
										<?php
										for ($contador = 1; $contador <= mysqli_num_rows($res_familias); $contador++) {
											if (mysqli_result($res_familias, $contador, "codfamilia") == $familia) { ?>
												<option value="<?php echo mysqli_result($res_familias, $i, "codfamilia") ?>" selected><?php echo mysqli_result($res_familias, $contador, "nombre") ?></option>
											<?php } else { ?>
												<option value="<?php echo mysqli_result($res_familias, $i, "codfamilia") ?>"><?php echo mysqli_result($res_familias, $contador, "nombre") ?></option>
										<?php }
										}
										?>
									</select>
							...
							<tr>
								...
								<td><select id="cboProveedores" name="cboProveedores" class="comboGrande">
										...
										<?php
										for ($contador = 1; $contador <= mysqli_num_rows($res_proveedores); $contador++) {
							...
							<tr>
								...
								<td><select id="cboUbicacion" name="cboUbicacion" class="comboGrande">
										...
										<?php
										for ($contador = 1; $contador <= mysqli_num_rows($res_ubicacion); $contador++) {
